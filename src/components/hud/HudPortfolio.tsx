    ...
    <>
      ...
      <div className="content-scroll">
        ...
        <section className="relative min-h-full flex flex-col">
          <div className="liquid-panel relative flex-1 m-3 md:m-4 min-h-[calc(100vh-var(--frame-bar)*2-24px)]">
            <div className="liquid-bg" />
            <div className="relative z-10 flex flex-col justify-between h-full min-h-[70vh] p-6 md:p-12 lg:p-16">
              <div className="flex items-start justify-between gap-4">
                <p className="hud-section-label">Sección · Liquid ether</p>
                <span className="font-mono text-[10px] tracking-widest text-black/35">
                  0014
                </span>
              </div>
              ...
              <div className="max-w-3xl py-16 md:py-24">
                <motion.p
                  ...
                  className="font-mono text-[11px] tracking-[0.28em] uppercase text-black/50 mb-5"
                >
                ...
                <motion.p
                  ...
                  className="mt-6 max-w-md text-base md:text-lg text-black/55 font-light leading-relaxed"
                >
                ...
                >
                  ...
                  <a
                    href="#projects"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-black/20 text-black/80 text-sm hover:border-black/40 transition-colors"
                  >
                    Proyectos
                  </a>
                </motion.div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-t border-black/10 pt-5">
                <div className="flex flex-wrap gap-x-6 gap-y-2">
                  {['Next.js', 'Flutter', 'AWS', 'Producto'].map((t) => (
                    <span
                      key={t}
                      className="font-mono text-[10px] tracking-[0.2em] uppercase text-black/40"
                    >
                      {t}
                    </span>
                  ))}
        ...
        <section id="about" className="section-dark px-6 md:px-12 lg:px-16 py-20 md:py-28">
          <div className="max-w-5xl mx-auto grid md:grid-cols-12 gap-10">
            <div className="md:col-span-4">
              <p className="font-mono text-[10px] tracking-[0.25em] uppercase text-white/35">
                02 // Mission
              </p>
        ...
        <section id="work" className="relative">
          <div className="liquid-panel m-3 md:m-4 overflow-hidden">
            <div className="liquid-bg opacity-90" />
            <div className="relative z-10 p-6 md:p-12 lg:p-16">
              ...
              <div className="mt-10 space-y-4">
                {protectedContent.experience.map((exp, i) => (
                  <motion.article
                    ...
                    className="rounded-2xl border border-black/10 bg-white/40 backdrop-blur-sm p-5 md:p-7"
                  >
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                      <div>
                        ...
                        <p className="text-sm font-medium text-black/60 mt-0.5">
                          {exp.company}
                        </p>
                    ...
                    <ul className="mt-4 space-y-2">
                      {exp.achievements.map((a) => (
                        <li
                          key={a.slice(0, 32)}
                          className="text-sm text-black/55 font-light leading-relaxed flex gap-2"
                        >
                          <span className="mt-2 h-1 w-1 rounded-full bg-black/40 shrink-0" />
                          {a}
                        </li>
                      ))}
                    </ul>
              ...
              <div className="mt-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {protectedContent.education.map((ed) => (
                    <div
                      ...
                      className="rounded-xl border border-black/10 bg-white/35 backdrop-blur-sm px-4 py-4"
                    >
                      ...
                      <p className="text-[10px] font-mono text-black/35 mt-2 uppercase">
                        {ed.period}
                      </p>
                    </div>
                  ))}
                ...
                {protectedContent.recognition && (
                  <div className="mt-4 rounded-2xl border border-black/15 bg-white/40 p-5 md:p-6">
                    <p className="font-mono text-[10px] tracking-widest uppercase text-black/45">
                      Reconocimiento
                    </p>
                    <p className="mt-2 text-base md:text-lg font-semibold text-black">
                      {protectedContent.recognition.title}
                    </p>
                    <p className="mt-2 text-sm text-black/50 font-light">
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-semibold tracking-tight mb-10">
              Proyectos
            </h2>
            ...
            <div className="space-y-6">
              {projects.map((p, i) => (
                <motion.article
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="grid md:grid-cols-12 gap-5 md:gap-8 items-center rounded-2xl border border-white/8 bg-white/[0.02] overflow-hidden"
                >
                  <div
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm text-white/45 font-light leading-relaxed">
                      {p.description}
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      {p.tags.map((t) => (
                        <span
                          key={t}
                          className="text-[10px] px-2 py-0.5 rounded border border-white/10 text-white/45"
                        >
                          {t}
                        </span>
                      ))}
        ...
        <section id="contact" className="relative pb-6">
          <div className="liquid-panel m-3 md:m-4 min-h-[50vh] flex items-center">
            ...
            <div className="relative z-10 w-full p-8 md:p-16 text-center">
              ...
              <p className="mt-4 text-black/50 font-light max-w-md mx-auto text-sm md:text-base">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-5 py-2.5 rounded-full border border-black/20 text-black/80 text-sm"
                >
                  LinkedIn
                </a>
                <a
        ...
        <footer className="section-dark px-6 py-6 flex flex-col sm:flex-row justify-between gap-2 text-[10px] font-mono text-white/25 tracking-wider">
